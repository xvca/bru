/*
  ...
  - You are about to alter the column `grind_size` on the `brews` table. The data in that column could be lost. The data in that column will be cast from `String` to `Float`.
...
INSERT INTO "new_brews" ("bar_id", "bean_id", "bloom_time", "brew_date", "brew_time", "brewer_id", "created_at", "dose_weight", "grind_size", "grinder_id", "id", "method", "pour_pattern", "rating", "tasting_notes", "user_id", "water_temperature", "yield_weight") SELECT "bar_id", "bean_id", "bloom_time", "brew_date", "brew_time", "brewer_id", "created_at", "dose_weight", "grind_size", "grinder_id", "id", "method", "pour_pattern", "rating", "tasting_notes", "user_id", "water_temperature", "yield_weight" FROM "brews";
DROP TABLE "brews";
