/*
  ...
  - Column `tasting_notes` on the `brews` table will be renamed to `notes`.
  - Column `pour_pattern` on the `brews` table will be dropped.
...
INSERT INTO "new_brews" ("auto_created", "bar_id", "bean_id", "bloom_time", "brew_time", "brewer_id", "created_at", "dose_weight", "grind_size", "grinder_id", "id", "method", "notes", "rating", "user_id", "water_temperature", "yield_weight") SELECT "auto_created", "bar_id", "bean_id", "bloom_time", "brew_time", "brewer_id", "created_at", "dose_weight", "grind_size", "grinder_id", "id", "method", "tasting_notes", "rating", "user_id", "water_temperature", "yield_weight" FROM "brews";
DROP TABLE "brews";
