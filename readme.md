...
A Next.js web application that interfaces with [Autobru](https://github.com/xvca/autobru), an ESP32-based system that connects to BOOKOO Bluetooth scales and Breville Dual Boiler espresso machines. Designed for coffee brewing with real-time weight, flow rate, and timing measurements.
